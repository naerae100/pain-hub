    ...
    if (!item) {
        return (
            <div className="min-h-[70vh] flex flex-col items-center justify-center p-8 text-center bg-secondary/20">
                ...
                <h2 className="text-3xl font-display font-bold text-blue-900 mb-4">Your cart is empty</h2>
    ...
    return (
        <div className="min-h-screen bg-secondary/10 pt-12 pb-24">
            <div className="section-container">
                <div className="mb-8">
                    <h1 className="text-4xl md:text-5xl font-display font-bold text-blue-950">Shopping Cart</h1>
                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-3xl border border-border overflow-hidden shadow-sm">
                            <div className="hidden md:grid grid-cols-12 gap-4 p-6 bg-secondary/30 text-sm font-bold text-blue-900 uppercase tracking-wider border-b border-border">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-4 md:p-6 items-center">
                                    <div className="md:col-span-6 flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <h3 className="text-xl font-bold text-blue-900 leading-tight mb-2">{item.title}</h3>
                                            {item.date && (
                                    ...
                                    <div className="md:col-span-2 md:text-center text-lg font-medium text-slate-600">
                                        <span className="md:hidden font-bold text-slate-400 text-xs uppercase mr-2">Price:</span>
                                        {item.price}
                                    </div>

                                    <div className="md:col-span-2 flex md:justify-center items-center">
                                        <span className="md:hidden font-bold text-slate-400 text-xs uppercase mr-4">Qty:</span>
                                    ...
                                    <div className="md:col-span-2 flex items-center justify-between md:justify-end gap-4">
                                        <span className="md:hidden font-bold text-slate-400 text-xs uppercase">Total:</span>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white p-8 rounded-3xl border border-border shadow-lg sticky top-28">
                            <h3 className="text-2xl font-display font-bold text-blue-900 mb-6">Order Summary</h3>
